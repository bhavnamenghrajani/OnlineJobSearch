...
public String handlerCodeN(
		@ModelAttribute("professionalDetails") ProfessionalDetails professionalDetails, BindingResult result, HttpServletRequest request) {
	...
	public ModelAndView addProfessionalDetailstoDB(
		...
		JobSeeker jobSeeker = (JobSeeker) request.getSession().getAttribute("loggedUser");
		System.out.println("Adding org:" + professionalDetails.getOrganizationName());
	...
	public ModelAndView editProfessionalDetails(@RequestParam("pdID") String professionalDetailsID, HttpServletRequest request) {
	...
	public ModelAndView editPDintoDB(@ModelAttribute("professionalDetails") ProfessionalDetails professionalDetails,BindingResult result,
		...
		System.out.println("New organization name:" + professionalDetails.getOrganizationName());
		System.out.println("Old value:" + professionalDetails.getJobTitle());
		System.out.println("Old ID value:" + professionalDetails.getProfessionalDetailsID());
		// professionalDetails.setJobSeeker(jobSeeker);
		userDAO.editPD(Integer.parseInt(ID), professionalDetails.getAddress(), professionalDetails.getAnnualPackage(),
				professionalDetails.getJobDescription(), professionalDetails.getJobTitle(),
				professionalDetails.getOrganizationName());
