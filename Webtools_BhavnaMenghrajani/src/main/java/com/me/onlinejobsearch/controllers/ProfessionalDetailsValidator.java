...
public class ProfessionalDetailsValidator implements Validator{
	...
	public void validate(Object obj, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "jobDescription", "error.invalid.jobDescription", "jobDescription Required");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "annualPackage", "error.invalid.annualPackage", "annualPackage Required");
