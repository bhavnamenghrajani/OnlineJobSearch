...
public class AdminConfigController {
	...
	public String initializeForm(@ModelAttribute("organization") Organization organization, BindingResult result,
	...
	protected String doSubmitAction(@ModelAttribute("organization") Organization organization, BindingResult result)
			throws Exception {
		try {
