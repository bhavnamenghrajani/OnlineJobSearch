...
public class SendEmail {
	...
	public void sendEmail(JobApplication jobApplication)
	{
		...
		email.setAuthenticator(new DefaultAuthenticator("forbhavna.m@gmail.com", "kanishkpoojaguddu"));
		email.setAuthentication("email@domain.com", "password");
		email.setStartTLSEnabled(true);
		try {
		         
		             email.setFrom("forbhavna.m@gmail.com");
		            ...
		            //Logger.getLogger(JavaApplication46.class.getName()).log(Level.SEVERE, null, ex);
						ex.printStackTrace();
