...
public class UserDAO extends DAO {
	...
	public ProfessionalDetails getProfessionalDetailsByID(String professionalDetailsID) {
		...
		try {
			begin();
			Query q = getSession()
					.createQuery("from ProfessionalDetails pd where pd.professionalDetailsID = :professionalDetailsID");
	...
	public AcademicDetails getAcademicDetailsByID(String academicDetailsID) {
		...
		try {
			begin();
			Query q = getSession()
					.createQuery("from AcademicDetails ad where ad.academicDetailsID = :academicDetailsID");
	...
	public void updatePersonalInformation(String userID, String addressLine1, String addressLine2, String city,
			String country, String countryState, String emailAddress, int homeCountryCode, int homePhone,
			int officeCountryCode, int officePhone, int zipCode) {
		// TODO Auto-generated method stub
