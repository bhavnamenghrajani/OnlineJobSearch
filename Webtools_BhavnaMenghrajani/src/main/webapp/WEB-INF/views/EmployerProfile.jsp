...
<div class="container">
  <h2>Please Profile Details</h2>
  <form:form action="EmployerProfile.htm" commandName="employer" method="post" class="form-horizontal" >
    <div class="form-group">
     ...
     <label class="col-sm-2 control-label">Designation:</label>
      <div class="col-sm-10">
        <form:input type="text" class="form-control" id="orgType" path="designation"/>
      </div>
      </div>
